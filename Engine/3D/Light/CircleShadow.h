...
/// <param name="lightpos">キャスター座標</param>
	inline void SetCasterPos(const Vector3& casterPos) {
...
/// <returns>キャスター座標</returns>
	inline const Vector3& GetCasterPos() {
		return casterPos_;
	}
...
/// <param name="lightFactorAngle">x:減衰開始角度 y:減衰終了角度[degree]</param>
	...
	inline const Vector2& GetFactorAngleCos() {
